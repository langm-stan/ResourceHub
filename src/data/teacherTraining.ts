      ...
      },
{
  ...
  {
    id: 'budgeting',
    title: 'Balance Sheets and Budgeting',
    short: 'Budgeting',
    description:
    ...
    tools: [
{
  ...
  {
    id: 'debt',
    title: 'Debt and Debt Management',
    ...
    tools: [
      {
        ...
        description: 'The cost of a degree against the raise it earns.',
      ...
      },
      {
        slug: 'student-loans',
        label: 'Student Loans',
        description: 'Subsidized and unsubsidized loans, and the rate a borrower actually pays.',
    ...
    tools: [
{
  ...
  },
  {
    ...
    short: 'Employer Benefits',
    description:
      'How retirement accounts are taxed, and what an employer match is worth.',
    tools: [
{
